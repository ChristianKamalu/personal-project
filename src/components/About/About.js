        ...
        <div style={{width: '100vw', display: 'flex', flexDirection: 'column', alignItems: 'center'}}>
            ...
            <div className='next-container' style={{backgroundColor: 'lightgrey'}}>
                <div className='our-goal-text'>
                    ...
                    <p>Bookie was created to give all students, both current and previous, the power to create personalized listings in order to purchase from and sell used textbooks to each other at a significantly lower price.</p>
                </div>
